...
author: "Reema Gupta, Laura Meier & Sara Lil Middleton"
format:
  revealjs:
    ...
    slide-number: true
    preview-links: auto
    footer: "FAIR Research Data Management | LMU Open Science Summer School 2026 | 1 hour 45 minutes"
    transition: slide
...
::: {.notes}
Welcome, everyone. So, I hope the data sharing lecture we just had has sufficiently inspired you to share your data and implement the FAIR principles. In this session, we will try translating that good intention into actual practice. This might feel daunting, but that's completely understandable.
...
# Part I: Why This Matters to YOU {.section-title .part .center background-color="#00883A"}
...
![](images/lets-document.png){width="80%"}
...
{{< video https://www.youtube.com/embed/N2zK3sAtr-4 width="840" height="472" >}}
...
:::: {.columns}
::: {.column width="50%"}
![](images/20260908-FAIR-RDM.png){width="80%"}
:::
...
[partici.fi/51717115](https://partici.fi/51717115)
...
# Part II: Making FAIR Tangible {.section-title .part .center background-color="#00883A"}
...
:::: {.columns}
::: {.column width="55%"}
![Ikeuchi, U. (2017). Open research data and research data management. *figshare*. [DOI: 10.6084/m9.figshare.3979746](https://doi.org/10.6084/m9.figshare.3979746) (CC BY 4.0)](images/open-data-rdm.png){width="90%" fig-alt="Pyramid of data openness: active data is managed and curated into closed, open with conditions, and fully open tiers, then preserved and published"}
:::

::: {.column width="45%"}
![[Ghent University](https://www.ugent.be/en/research/openscience/datamanagement/after-research/fair-data.htm)](images/ugent-fair-open.png){width="85%" fig-alt="Venn diagram: FAIR data sits inside managed data, and open data partially overlaps both"}
:::
::::
...
![](images/RDM-session-ss-2026.png)

::: {.callout-tip}
#### Related Session Alert
**Wednesday 9th September, 13:15 - 14:15: Research Data Management Plans**
:::
...
Visit [partici.fi/51717115](https://partici.fi/51717115) to participate
:::

::: {.column width="30%"}
![](images/20260908-FAIR-RDM.png){width="60%"}
:::
::::
...
Source: Adapted from So, Why Go FAIR? April 17, 2023 [osf.io/2jbps](https://osf.io/2jbps/)
:::
...
# Part III: Managing Data for Your Future Self and Collaborators {.section-title .part .center background-color="#00883A"}
...
::: {.column width="50%"}
![](images/experimentales-002_typical-story-line-about-order.png){height="560"}
...
::: {.column width="40%"}
![](images/folder-hierarchy.svg){height="560"}
:::
...
:::: {.columns}
::: {.column width="32%"}
![](images/not-final-doc-phdcomic.gif){width="70%"}
...
##### Related Session Alert
**Wednesday 9 September, 14:30-17:30: Version control in RStudio with Git**
:::
...
:::: {.columns}
::: {.column width="40%"}
![](images/norm_normal_file_format_2x.png){width="55%"}
...
# Part IV: Creating Research Data for Unexpected Reuse {.section-title .part .center background-color="#00883A"}
...
:::: {.columns}
::: {.column width="60%"}
![Carroll et al. (2020). The CARE Principles for Indigenous Data Governance. *Data Science Journal*. [DOI: 10.5334/dsj-2020-043](https://datascience.codata.org/articles/10.5334/dsj-2020-043)](images/care-principles.png){width="42%"}
:::
...
# Part V: Sharing Your Data with the World {.section-title .part .center background-color="#00883A"}
...
![](images/bmc-research-note-ss.png){style="position: absolute; top: 220px; left: 60px; z-index: 2; width: 85%;"}
:::
:::
:::::
...
# Wrap-Up: Your FAIR Data Journey {.section-title .part .center background-color="#00883A"}
...
::: {.column width="60%"}
![[**lmu-osc.github.io/FAIR-Data-Management/**](https://lmu-osc.github.io/FAIR-Data-Management/)](images/optional-follow-up-ss.png){width="90%"}
:::
::::
...
- **Kleemeyer, M., Leiminger, L., Meier, L. & Walter, D. (2024).** FAIR Research Data Management Workshop  
  [lmu-osc.github.io/FAIR-Data-Management/](https://lmu-osc.github.io/FAIR-Data-Management/)

- **Research Data Management in Neuroscience**  
  Course materials by Thomas Wachtler, LMU Munich

- **So, Why Go FAIR?**  
  April 17, 2023: [osf.io/2jbps](https://osf.io/2jbps)