...
author: "Reema Gupta, Laura Meier & Sara Middleton"
format:
  revealjs:
    theme: default
    slide-number: true
...
::: {.column width="50%"}
![](images/experimentales-002_typical-story-line-about-order.png){width="80%"}
...
:::: {.columns}
::: {.column width="32%"}
![](images/not-final-doc-phdcomic.gif){width="80%"}
...
:::: {.columns}
::: {.column width="40%"}
![](images/norm_normal_file_format_2x.png){width="70%"}
