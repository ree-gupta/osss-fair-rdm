...
<style>
/* Custom styles for FAIR Research Data Management slides */
.center {
...
::: {.notes}
By the end of this session, you will understand what parts of FAIR data management are actually your responsibility versus what is handled by the tools you choose. You will know how to find and adopt standards your field already uses, avoiding the trap of trying to invent new ones. You will gain practical skills for organizing, documenting, and sharing your data in a way that makes it usable for others. And most importantly, you will leave with one concrete next step that you can take within the next month to improve your data management practices. My main goal today is to move you from overwhelm to confidence through practical, manageable steps and hopefully nudge you to be an active part of your research community's data culture.
:::
...
2016: FAIR principles published (Wilkinson et al., Scientific Data)[^3]
:::
...
[^3]: Wilkinson et al. (2016). The FAIR Guiding Principles for scientific data management. Scientific Data 3:160018
...
::: {.column width="60%"}
![FAIR Principles. *The Turing Way project illustration by Scriberia. Used under a CC-BY 4.0 licence. DOI: 10.5281/zenodo.3332807*](images/fair-principles.svg){fig-alt="Illustration of FAIR principles showing Findable, Accessible, Interoperable, and Reusable concepts" fig-align="center"}
:::
...
![Metadata Framework adapted from Sobolev et al. (2014). Integrated platform and API for electrophysiological data. Front Neuroinform, 8:32. doi: 10.3389/fninf.2014.00032](images/metadata-framework.svg)
...
<!-- ## Activity: Fix These Names {.center .smallestish}
:::: {.columns}

::: {.column width="48%"}
### Problematic Filenames

1. `Mike's final data (v2).xlsx`  
   - *Problems: Spaces, apostrophe, parentheses*

2. `results*.csv`  
   - *Problems: Asterisk is a wildcard character*

3. `föhrmann_daten_2025.txt`  
   - *Problems: Umlaut (ö) causes encoding issues*

4. `truly_final_version_USE_THIS_ONE_definitely_final_v2.doc`  
   - *Problems: Too long, desperate versioning*
:::
::: {.column width="4%"}
:::
...
1. `mike_data_2025-01-15_v02.xlsx`

2. `results_2025-01-15_v01.csv`

3. `foehrmann_data_2025-01-15_v01.txt`

4. `manuscript_2025-01-15_final.docx`
:::

::::

::: {.notes}
Take about 60 seconds to examine these examples, they're all real filenames one could encounter in research projects. What problems can you spot?

The first example violates multiple rules: the apostrophe and spaces would cause failures on Linux systems, and the parentheses create script errors. The second filename includes an asterisk, which computers interpret as a wildcard that would match multiple files in scripts. The third uses an umlaut that causes character encoding problems across different systems. The fourth is what I call "a cry for help in filename form", it's way too long and shows someone struggling to keep track of versions of their work.

Notice how the improved versions might look boring, but they're completely functional and won't cause technical headaches. Sometimes boring is exactly what you want in a filename.
::: -->
...
- **JARS** for psychological studies
:::
:::
...
CONSORT, ARRIVE, JARS - these aren't arbitrary rules. They're checklists developed by researchers who've tried to replicate studies or reuse data and discovered what information is actually essential. They represent the collective experience of your field about what details matter.

Use them as your safety net. They help ensure your data can answer not just today's questions, but tomorrow's questions too.
:::
...
::: {.fragment}
#### Some examples include:
- **Gene Ontology** for molecular biology
- **MeSH terms** for medical research  
- **EDAM** for bioinformatics tools/data
:::
:::
::::
...
![Ihle, M., Villagran Asiares, A. G., Betz, A. K., Gupta, R., & Koerte, I. K. (2025). cBRAIN open research practice guide (1.0). Zenodo. https://doi.org/10.5281/zenodo.16262261](images/open-research-practice-guide-ss.png)
...
4. **Note:** Organizational standards, reporting guidelines, vocabularies
5. **Backup:** If nothing fits, check "Your Data" section by data type
:::
:::
...
::: {.fragment}
#### Remember:
- This isn't about finding the *perfect* standard
- It's about discovering what already exists
- Even partial solutions count
- Your field's informal practices matter too
:::
:::
::::
...
Start at rdmkit.elixir-europe.org and go to the "Your Domain" section. Find your field or the closest match - don't worry if it's not perfect. Look for what they recommend for data organization, reporting, and vocabularies. If your field isn't listed, try the "Your Data" section and browse by data type instead.

This isn't about finding the one perfect standard that solves everything. It's about discovering what your community has already figured out, even if it's incomplete. A 60% solution you can build on is infinitely better than starting from zero.

After 5 minutes, we'll have people share what they found using the template on the next slide.
:::
...
**One organizational standard I found:** _________________________________  
*(or "None found - will adopt practices from [researcher/data publication/lab name]")*

**One reporting guideline that applies:** _________________________________  
*(or "Will use journal requirements as starting point")*

**One vocabulary/terminology resource:** _________________________________  
*(or "Will create glossary for my research group")*

::: {.notes}
Give everyone the worksheet to fill out during the activity. This keeps them focused and gives us concrete talking points when we reconvene. The template acknowledges that they might not find perfect matches and provides backup options. The "next step" question forces them to commit to one small action they can take immediately.
:::
...
::: {.column width="40%" .fragment data-id="cc-licenses"}
![creativecommons.org, CC BY-SA 4.0](images/256px-Ordering_of_Creative_Commons_licenses_from_most_to_least_permissive.png)
:::
::::

::: {.notes}
There are several licenses out there, Creative Commons, MIT, Apache, Open Data Commons—and ultimately it's your responsibility to pick one. If you don't want to read through all the options, Creative Commons licenses are usually a safe choice for research data. Remember this rule of thumb: go with the least restrictive license to maximize your data's reuse potential.
:::
...
::: {.fragment}
CC-BY is just "cite me" - what researchers already do
:::
...
::: {.fragment}
CC0 solves this: Universally compatible, zero restrictions
:::
...
- Field-specific visibility? → Disciplinary repositories
- Sensitive data + compliance? → Institutional repositories
- Active collaboration? → Platforms with version control (OSF, GitHub)
:::

::: {.notes}
Your repository choice should be strategic. If you want maximum discoverability across all fields, general repositories like Zenodo or Figshare are great. If you want your research community to find you, look for disciplinary repositories. If you're dealing
with sensitive data and need institutional support, your university repository might be best. And if you're actively collaborating and need version control, platforms like OSF or GitHub work well. Let me show you re3data.org, where you can filter
repositories by your subject area to find the right fit.
:::
...
4. Make a search for "Zenodo", "OSF", or "Figshare" if nothing field-specific appears

::: {.notes}
Let's spend 3 minutes finding your repository options. Go to re3data.org and filter by your subject area first. Look for the key features we just discussed: data upload allowed, DOI assignment, and ideally some certification.
...
## The Four PIDs You Need to Know {.center}

::: {.incremental}
- DOI → What you created (datasets, papers)
- ORCID → Who you are (your researcher identity)
- RRID → What you used (materials, software)
- ROR → Where you work (institution)
:::
...
## Data Availability Statement: Connecting All the Pieces {.center}
...
::: {.fragment}
A clear "Data Availability Statement" connects all the pieces
:::
...
## Data Availability Statement Examples {.center .smaller}
...
## First Simple FAIR Checklist {.center .nonincremental}
...
#### Active Research
- [ ] README updated monthly
- [ ] Data dictionary growing
- [ ] Raw data protected
- [ ] Versions tracked
:::
...
::: {.notes}
**Speaker Notes:**
Here's your tangible takeaway - a FAIR checklist organized by research phase. Depeding on your project stage, you can focus on different sections.
:::

## OPTIONAL Follow-Up

We have a self-guided tutorial where you evaluate already published datasets for FAIRness. You have guiding questions and a revisit of the FAIR principles. You can do this on your own time, and it's a great way to see how other researchers are (or not) implementing these concepts in practice.
